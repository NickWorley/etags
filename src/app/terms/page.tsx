...
export const metadata: Metadata = {
    title: 'Terms of Service | Click-4-Coverage',
    description:
        'Read the terms and conditiions that govern your use of Click-4-Coverage services and website.',
};
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:py-40">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-navy-100/80 sm:text-xl">
                            These Terms of Service explain how Click4Coverage provides its services and how you
            ...
            <section className="bg-white py-24">
                <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 space-y-10 text-sm leading-relaxed text-navy-700">
                    <section>
                        ...
                        <p>
                            By accessing or using the Click4Coverage website, requesting a quote, or purchasing
                    ...
                    <section>
                        ...
                        <p>
                            Click4Coverage sells Vehicle Service Contracts and related protection products. We do
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            owned by or licensed to Click4Coverage and may not be reproduced, distributed, or
                    ...
                    <section>
                        ...
                        <p>
                            To the extent permitted by law, Click4Coverage and its affiliates will not be liable
